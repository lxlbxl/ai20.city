...
INDUSTRIES = [
    {"name": "Healthcare", "slug": "healthcare", "desc": "Transform patient care and operational efficiency with medical-grade AI."},
    {"name": "Legal", "slug": "legal", "desc": "Automate case research, contract review, and client communication."},
    {"name": "Finance", "slug": "finance", "desc": "Next-generation fraud detection, algorithmic trading, and personalized banking."},
    {"name": "E-commerce", "slug": "ecommerce", "desc": "Hyper-personalization and dynamic pricing engines for modern retail."},
    {"name": "Real Estate", "slug": "real-estate", "desc": "Predictive market analysis and automated property management."}
]
                ...
                <div class="space-y-16">
                    ...
                    <div class="border-t border-[#050505]/10 pt-12">
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                <h4 class="font-bold mb-2">Is this compliant with the EU AI Act?</h4>
                                <p class="opacity-70 text-sm">Yes, all our frameworks are designed with strict adherence to EU AI Act compliance and GDPR regulations.</p>
                            </div>
                             <div>
    ...
    for city in CITIES:
        ...
        <main class="max-w-[1400px] mx-auto px-6 md:px-12 py-20">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-24">
                ...
                <div class="p-8 border border-[#050505]/10 hover:border-[#ff3300] transition-colors group">
                    <h3 class="font-serif-display text-2xl italic mb-4">EU Compliance</h3>
                    <p class="text-sm opacity-70">Fully GDPR and EU AI Act compliant solutions, secure by default.</p>
                </div>
                <div class="p-8 border border-[#050505]/10 hover:border-[#ff3300] transition-colors group">
